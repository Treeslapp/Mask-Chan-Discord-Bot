...
roles = ["Stone", "Stone (Honorary)", "Ryu-Goat", "Campaign Inactive", "Campaign Active", "Moby Dick-Heads"]

game_roles = {"Sloppy Friends":["Gamble With Your Friends", "PEAK", "RV There Yet?", "PICO PARK", "FPS Chess", "Supermarket Together", "Cave Crawlers", "Stumble Guys", "Garry's Mod", "Overcooked! 2"], 
...
rp_roles = ["Anchor (Hard R)", "Castlevania Heroes", "Victims of Night", "Real/Fake?", "Party Members (Legacy)", "Tristan's Secretary", "Please Unban Tristan :(", "Duelist", "Sweaty Virgin (Comic Con)"]
